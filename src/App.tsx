            ...
            <div style={{ flex: 1, display: "flex", flexDirection: "column", minHeight: 0, overflow: "hidden", position:"relative" }}>
              ...
              <div style={{ flex:1, display:"flex", flexDirection:"column", minHeight:0, borderBottom: lands.length > 0 ? "1px solid #1a1a2e" : "none", position:"relative" }}>
                ...
                <div
                  ...
                  style={{ flex:1, overflowX:"auto", overflowY:"hidden", padding:"4px 8px", paddingTop: isMe ? "20px" : "4px", paddingRight: isMe ? 210 : 8, display:"flex", flexDirection:"row", gap:5, alignItems:"flex-start", flexWrap:"nowrap", minHeight:90 }}>
                ...
                {(isMe || permanents.some(c => row2Cards.has(c.instanceId))) && (
                  <div
                    ...
                    style={{ overflowX:"auto", overflowY:"hidden", padding:"4px 8px", paddingRight: isMe ? 210 : 8, display:"flex", flexDirection:"row", gap:5, alignItems:"flex-start", flexWrap:"nowrap", minHeight:isMe ? 85 : 0, borderTop:"1px dashed #1a1a2e", background: isMe ? "#04040a" : "transparent" }}>
                    {permanents.filter(c => row2Cards.has(c.instanceId)).map(c => renderCard(c))}
              ...
              {isMe && (
                <div style={{ position:"absolute", top:4, right:4, minWidth:160, maxWidth:200, maxHeight:"calc(100% - 8px)", background:"#07070fee", border:"1px solid #2a2a3a", borderRadius:8, padding:"6px 8px", zIndex:20, pointerEvents:"auto", overflowY:"auto", display:"flex", flexDirection:"column" }}>
