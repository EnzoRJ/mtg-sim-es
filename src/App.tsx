        ...
        {(() => {
          ...
          return (
            <div style={{ flex:1, display:"flex", flexDirection:"row", overflow:"hidden", minHeight:0 }}>
              {/* Rows + Lands wrapper */}
              <div style={{ flex:1, display:"grid", gridTemplateRows: isMe ? "45% 45% 10%" : "auto", overflow:"hidden", minWidth:0 }}>
              ...
              {(isMe || permanents.some(c => row2Cards.has(c.instanceId))) && (
                <div
                  ...
                  style={{ overflow:"hidden", overflowX:"auto", padding:"4px 8px", display:"flex", gap:5, alignItems:"flex-start", flexWrap:"nowrap", borderTop:"1px solid #1a1a2e", borderBottom: lands.length > 0 ? "1px solid #1a1a2e" : "none", background: isMe ? "#050508" : "transparent" }}>
                  {permanents.filter(c => row2Cards.has(c.instanceId)).map(c => renderCard(c))}
                  {isMe && !permanents.some(c => row2Cards.has(c.instanceId)) && (
              ...
              <div style={{ overflow:"hidden", overflowX:"auto", padding:"3px 6px", display:"flex", flexDirection:"row", gap:4, alignItems:"center", background:"#060609", flexWrap:"nowrap", minHeight: lands.length > 0 ? 56 : 20, maxHeight: lands.length > 0 ? 90 : 20 }}>
                {lands.length > 0
                  ? <>
