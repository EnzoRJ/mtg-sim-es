          ...
          {(() => {
            ...
            return (
              <div style={{ flex: 1, display: "flex", flexDirection: "column", minHeight: 0, overflow: "hidden", position: "relative" }}>
                ...
                <div style={{ flex: 1, display: "flex", flexDirection: "row", minHeight: 0, borderBottom: lands.length > 0 ? "1px solid #1a1a2e" : "none" }}>
                  ...
                  <div style={{ flex: 1, display: "flex", flexDirection: "column", minWidth: 0, minHeight: 0 }}>
                    ...
                    <div
                      ...
                      onDrop={e => { e.preventDefault(); if (dragCard && isMe) setRow2Cards(s => { const n = new Set(s); n.delete(dragCard.instanceId); return n; }); setDragCard(null); setDragOverId(null); }}
