          ...
          {(() => {
            ...
            const renderCard = (card, zone = "battlefield") => {
              ...
              return (
                <div key={card.instanceId}
                  ...
                  style={{ position: "relative", opacity: isDragging ? 0.4 : 1, outline: isOver ? "2px dashed #ffd700" : "none", borderRadius: 6, cursor: isMe ? "grab" : "default", transition: "opacity 0.15s", overflow: "visible" }}
            ...
            return (
              <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden", minHeight: 0 }}>
                ...
                <div style={{ position: "relative", flexShrink: 0, height: isMe ? 120 : 82, borderBottom: "1px solid #1a1a2e", overflow: "hidden" }}>
                  ...
                  <div
                    ...
                    style={{ height: "100%", overflowX: "auto", overflowY: "hidden", paddingRight: isMe ? 170 : 0, padding: "6px 8px", paddingRight: isMe ? 170 : 8, display: "flex", gap: 5, alignItems: "flex-start", flexWrap: "nowrap" }}>
                  ...
                  {/* LOG — absolute inside Row 1, top-right */}
                  {isMe && (
                    <div style={{ position: "absolute", top: 4, right: 4, width: 160, maxHeight: 112, background: "#07070fee", border: "1px solid #2a2a3a", borderRadius: 8, zIndex: 10, display: "flex", flexDirection: "column", overflow: "hidden" }}>
                      <div style={{ fontSize: 8, color: "#ffd700", letterSpacing: 2, padding: "3px 0", textAlign: "center", borderBottom: "1px solid #1a1a2e", flexShrink: 0 }}>LOG</div>
                      <div style={{ flex: 1, padding: "3px 6px", overflowY: "auto" }}>
                          ...
                          return (
                            <div key={group.turn} style={{ marginBottom: 2 }}>
                              <div onClick={() => setLogCollapsed(c => ({ ...c, [group.turn]: !isCollapsed }))}
                                style={{ fontSize: 8, fontWeight: 800, color: "#ffd700aa", padding: "1px 0", cursor: "pointer", display: "flex", justifyContent: "space-between" }}>
                ...
                {(isMe || permanents.some(c => row2Cards.has(c.instanceId))) && (
                  <div
                    ...
                    style={{ flexShrink: 0, height: isMe ? 120 : 0, overflowX: "auto", overflowY: "hidden", padding: "4px 8px", display: "flex", gap: 5, alignItems: "flex-start", flexWrap: "nowrap", borderBottom: lands.length > 0 ? "1px solid #1a1a2e" : "none", background: isMe ? "#050508" : "transparent" }}>
                    {permanents.filter(c => row2Cards.has(c.instanceId)).map(c => renderCard(c))}
                    {isMe && !permanents.some(c => row2Cards.has(c.instanceId)) && (
                ...
                <div style={{ flexShrink: 0, height: lands.length > 0 ? 82 : 22, overflowX: "auto", overflowY: "hidden", padding: "4px 6px", display: "flex", flexDirection: "row", gap: 5, alignItems: "center", background: "#060609", flexWrap: "nowrap" }}>
                  {lands.length > 0
                    ? <>
