...
function CardTile({ card, onClick, onDoubleClick, onRightClick, onHover, onHoverEnd, small, tapped, selected, faceDown }) {
  ...
  return (
    <div onClick={onClick}
      ...
      {faceDown
        ? <img src="https://cards.scryfall.io/normal/back/0/0/00000000-0000-0000-0000-000000000000.jpg" style={{ width:"100%", height:"100%", objectFit:"cover" }} onError={e => { e.target.style.display="none"; e.target.nextSibling.style.display="flex"; }} />
        : null}
      {faceDown && <div style={{ display:"none", width:"100%", height:"100%", background:"linear-gradient(135deg,#1a2a4a,#0d1a2e)", alignItems:"center", justifyContent:"center", fontSize:22 }}>🎴</div>}
      {!faceDown
        : imgUrl
