          ...
          {(() => {
            ...
            return (
              <div style={{ flex: 1, display: "flex", flexDirection: "column", minHeight: 0, overflow: "hidden", position: "relative" }}>
                ...
                {isMe && (
                  <div style={{ position: "absolute", top: 4, right: 4, minWidth: 160, maxWidth: 200, background: "#07070fee", border: "1px solid #2a2a3a", borderRadius: 8, padding: "6px 8px", zIndex: 20, pointerEvents: "auto" }}>
