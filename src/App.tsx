        ...
        {(() => {
          ...
          return (
            <div style={{ flex:1, display:"flex", flexDirection:"row", overflow:"hidden", minHeight:0 }}>
              ...
              <div style={{ position:"relative", flex:1, minHeight:116, overflow:"hidden", borderBottom:"1px solid #1a1a2e" }}>
              ...
              {(isMe || permanents.some(c => row2Cards.has(c.instanceId))) && (
                <div
                  ...
                  ref={isMe ? scrollRef2 : null} style={{ flex: isMe ? 1 : "0 0 0px", minHeight: isMe ? 116 : 0, overflowX:"auto", overflow:"hidden", padding:"4px 8px", display:"flex", gap:5, alignItems:"flex-start", flexWrap:"nowrap", borderTop:"1px solid #1a1a2e", borderBottom: lands.length > 0 ? "1px solid #1a1a2e" : "none", background: isMe ? "#050508" : "transparent" }}>
                  {permanents.filter(c => row2Cards.has(c.instanceId)).map(c => renderCard(c))}
                  {isMe && !permanents.some(c => row2Cards.has(c.instanceId)) && (
